...
public class ItemEmeraldBow extends Item {
	public static final String[] emeraldBowPullIconNameArray = new String[] {"emerald_bow_pulling_0", "emerald_bow_pulling_1", "emerald_bow_pulling_2"};
